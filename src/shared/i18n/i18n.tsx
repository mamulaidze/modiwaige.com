...
const translations: Record<string, string> = {
  'Free giving in Georgia': 'უფასო ნივთები საქართველოში',
  Home: 'მთავარი',
  Create: 'დამატება',
  Profile: 'პროფილი',
  Admin: 'ადმინი',
  ...
  'Free items in Georgia': 'უფასო ნივთები საქართველოში',
  'Find unwanted items people are giving away and help keep useful things out of waste.':
    'იპოვე ნივთები, რომლებსაც ადამიანები უფასოდ ჩუქნიან, და დაეხმარე სასარგებლო ნივთებს ნარჩენებად არ იქცნენ.',
