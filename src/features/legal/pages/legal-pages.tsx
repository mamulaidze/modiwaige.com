      ...
      sections: [
        {
          ...
          body: [
            'ანგარიშის მონაცემებს, როგორიცაა სახელი, ელფოსტა, ტელეფონის ნომერი.',
            'განცხადების ინფორმაციას, მათ შორის აღწერას, დანიშნულ ქალაქს, კატეგორიას და ატვირთულ ფოტოებს.',
            'ჯავშნების, რეპორტების, მოდერაციის და ტექნიკურ მონაცემებს, რომლებიც სერვისის უსაფრთხოებისთვის საჭიროა.',
          ],
        },
        {
          heading: 'რაში ვიყენებთ მოცემულ ინფორმაციას?',
          body: [
            'განცხადების ჩვენებისთვის, გადაცემის პირობების შეთანხმებისთვის, ჯავშნების მართვისათვის, რეპორტების განხილვისთვის და სერვისის წესების დასაცავად',
            'ტელეფონი ან საკონტაქტო ინფორმაცია შეიძლება გამოჩნდეს სხვა მომხმარებლისთვის, როდესაც ეს ნივთის გადაცემის შეთანხმებისთვისაა საჭიროა.',
        ...
        },
        {
          ...
          body: [
            'ანგარიშის წაშლის მოთხოვნა შეგიძლიათ ანგარიშის პარამეტრებიდან',
            'კონფიდენციალურობასთან დაკავშირებული კითხვებისთვის და ანგარიშის წაშლაში დახმარებისთვის დაგვიკავშირდით Contact გვერდიდან.',
          ],
        },
      ],
    },
      ...
      sections: [
        {
          ...
          body: [
            'გამოიყენეთ აპი კეთილსინდისიერად და განათავსეთ მხოლოდ ის ნივთები, რომელთა გაჩუქების უფლება გაქვთ.',
            'განცხადებები, ფოტოები, ტელეფონის ნომრები და სხვა გაზიარებული ინფორმაცია უნდა იყოს ზუსტი და პატივისცემით დაწერილი.',
            'Gaachuqe-ს შეუძლია წაშალოს განცხადებები, შეზღუდოს ანგარიშები ან განიხილოს რეპორტები, წესების დარღვევის შემთხვევაში.',
          ],
        },
        {
          heading: 'გაყიდვის ან გარანტიის გარეშე',
          body: [
            'Gaachuqe-ზე ყველა ნივთი უნდა იყოს უფასოდ შეთავაზებული.',
            'აპი არ ამოწმებს ნივთებს, არ იძლევა მდგომარეობის გარანტიას და არ ჰპირდება, რომ ნივთის მიღება აუცილებლად შედგება.',
      ...
      sections: [
        {
          ...
          body: [
            'შეძლებისდაგვარად შეხვდით საჯარო ადგილას, განსაკუთრებით უცნობ პიროვნებას.',
            'გაუზიარეთ ახლობელს ან მეგობარს შეხვედრის ადგილი, არ გააზიაროთ არასაჭირო პირადი ინფორმაცია და ენდეთ საკუთარ შეფასებას.',
            'უფასო ნივთის მისაღებად არ გააგზავნოთ ფული, დეპოზიტი, კოდები ან რაიმე სახის პირადი დოკუმენტები.',
          ],
        },
        {
          heading: 'აკრძალული კონტენტი',
          body: [
            'არ განათავსოთ უკანონო ნივთები, იარაღი, სახიფათო საქონელი, გამოწვეული პროდუქტები, მოპარული ნივთები, ზრდასრულთა კონტენტი ან ნივთები, რომლებსაც სპეციალური ლიცენზია სჭირდებათ.',
            'აკრძალულია შეურაცხყოფა, მუქარა, სხვისი სახელით მოქმედება, სპამი ან აპის ნივთების გაყიდვებისთვის გამოყენება.',
        ...
        },
        {
          ...
          body: [
            'გამოიყენეთ რეპორტი, როდესაც განცხადება ან მომხმარებელი სახიფათო, მცდარი, შეურაცხმყოფელი ან წესების დამრღვეველი ჩანს.',
            'მოდერატორებს შეუძლიათ რეპორტების განხილვა და საჭიროების შემთხვევაში კონტენტის წაშლა ან ანგარიშის შეზღუდვა.',
          ],
        },
      ],
    },
  ...
  contact: {
    ...
    ge: {
      ...
      sections: [
        ...
        {
          heading: 'რა ინფორმაციის გადმოცემა შეგიძლიათ ჩვენთვის',
          body: [
            'მიუთითეთ ანგარიშის ელფოსტა, განცხადების ბმული თუ საჭიროა, და პრობლემის მოკლე აღწერა.',
            'არ გააგზავნოთ პაროლები, საბანკო ბარათის მონაცემები ან პირადობის დამადასტურებელი დოკუმენტი, თუ ამას დადასტურებული მხარდაჭერის პროცესი არ ითხოვს.',
          ],
        },
      ],
    },
